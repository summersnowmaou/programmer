<html>
	<head>
		<meta http-equiv="content-type" countent="text/html; charset=utf-8">
...
<?php
	...
	//以下两条代码连接MYSQL数据库版本信息
//	mysql_connect("localhost", "root", "root");
	$link = mysqli_connect('localhost', 'root', '123456', 'dbname');
