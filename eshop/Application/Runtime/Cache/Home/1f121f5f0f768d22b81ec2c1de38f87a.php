...
<html>
	<head>
		<meta charset="utf-8">
		<link href="/eshop/Public/Home/css/index.css" type="text/css" rel="stylesheet">
	...
	<body id="top">
			...
			<div class="header-box">
				...
				<ul class="header-right">
					...
					<li class="my bj">
						...
						<div class="my1">
							<div class="my2">
								<img src="/eshop/Public/Home/images/no-img_mid_.jpg">
								<div class="my3">
					...
					<li class="shouji bj">
						...
						<div class="shouji1">
							<img src="/eshop/Public/Home/images/11.jpg"class="shouji4">
							<div class="shouji2">
								<p>京东客户端</p>
								<p class="red">首次下单满79元，送79元</p>
								<img src="/eshop/Public/Home/images/333.jpg" class="shouji3">
								<img src="/eshop/Public/Home/images/333.jpg" class="shouji3">
								<img src="/eshop/Public/Home/images/333.jpg" class="shouji3">
								
							</div>
							<div class="yi">
								<img src="/eshop/Public/Home/images/222.jpg"class="shouji4">
								<div class="er">
									<p>京东钱包客户端</p>
					...
					<li class="guanzhu bj">
						...
						<div class="guanzhu1"><img src="/eshop/Public/Home/images/54c84f72Ncc1a02a2.jpg"></div>
					</li>
					<li class="shu"></li>
					<li class="kehu bj">
						<a href="#">客户服务</a>
		...
		<div id="top-banner">
			<div class="top-ba">
				<a href=""><img src="/eshop/Public/Home/images/js.jpg"></a>
				<div id="xx"><a href="">X</a></div>
			</div>
			
		</div>
		<div class="w">
			<div class="logo"><a href=""><img src="/eshop/Public/Home/images/bilibili.png"></a></div>
			<div class="search">
				<input type="text" value="家电一折抢" class="text" id="textt">
				<button class="button">搜索</button>
			</div>
			<div class="right">
				<i class="gw-left" style="background:url(/eshop/Public/Home/images/jd2015img.png)0 -58px no-repeat;width:24px;height:24px;"></i>
				<i class="gw-right">></i>
				<i class="gw-count">0</i>
				<a href="#">我的购物车</a>
				<div class="dorpdown-layer">
					<img src="/eshop/Public/Home/images/settleup-nogoods.png">
					购物车中还没有商品，赶紧选购吧！
				</div>
			</div>
			<div class="hotwords">
		...
		<!--轮播图上方导航栏  一栏-->
		<div id="navv">
			<div class="nav-img" style="background:url(/eshop/Public/Home/images/568a1258N2edec1ab.jpg) repeat-x"></div>
			<div class="nav-imgs" style="background:url(/eshop/Public/Home/images/568a0a8eNe8f4df82.jpg) no-repeat center top"></div>	
		</div>
		<div class="focus">
			<div class="focus-a">
				<div class="fouc-img1"><img src="/eshop/Public/Home/images/5689d4ebN19f155a6.jpg" class="nav-img2"></div>
			...
			<div class="focus-c"><a href=""><img src="/eshop/Public/Home/images/hhh.jpg"></a></div>
			<div class="focus-d"><a href=""><img src="/eshop/Public/Home/images/nianhuo.jpg"></a></div>
			<!--轮播图左边当行蓝-->
			<div class="bb"></div>
			<div class="dd-inner">
				<div class="font-item">
					...
					<div class="font-item1">
						...
						<div class="font-right">
							<div>
								<a href="#">
									<img src="/eshop/Public/Home/images/562f4971Na5379aba.jpg">
								</a>
								<a href="#">
									<img src="/eshop/Public/Home/images/54d9eef9N5bb8d27f.jpg">
								</a>
								<a href="#">
									<img src="/eshop/Public/Home/images/54d9ef02N99d26435.jpg">
								</a>
								<a href="#">
									<img src="/eshop/Public/Home/images/54d9ef10Nd206a236.jpg">
								</a>
								<a href="#">
									<img src="/eshop/Public/Home/images/54d9ef28N00328d44.jpg">
								</a>
								<a href="#">
									<img src="/eshop/Public/Home/images/54d9ef34N7cc61f4c.jpg">
								</a>
								<a href="#">
									<img src="/eshop/Public/Home/images/54d9ef3eN99aef1f0.jpg">
								</a>
								<a href="#">
									<img src="/eshop/Public/Home/images/54d9ef4cN4fe57f9b.jpg">
								</a>
							</div>
						</div>
						<div class="font-righty">
							<a href="#">
								<img src="/eshop/Public/Home/images/5673a854N10856704.jpg">
							</a>
							<a href="#">
								<img src="/eshop/Public/Home/images/56a0376aN7de1bdcf.jpg">
							</a>
						</div>
					</div>
				</div>
				<div class="fore-2">
					...
					<div class="font-item1">
						...
						<div class="font-right">
							<div>
								<a href="#"><img src="/eshop/Public/Home/images/55f7e052N91fe7821.gif"></a><a href="#"><img src="/eshop/Public/Home/images/566b9856N9be09c56.png"></a><a href="#"><img src="/eshop/Public/Home/images/56302f25N84147dce.jpg"></a><a href="#"><img src="/eshop/Public/Home/images/54dac932Nb84e058e.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9d1e9Nfb4684e5.jpg"></a><a href="#"><img src="/eshop/Public/Home/images/566e5771N0e6950ee.jpg"></a><a href="#"><img src="/eshop/Public/Home/images/55b1d930Nf0bfccbb.jpg"></a><a href="#"><img src="/eshop/Public/Home/images/554a11bbN7bb7f655.jpg"></a>
							</div>
						</div>
						<div class="font-righty">
							<a href="#"><img src="/eshop/Public/Home/images/5693228dN146c521c.jpg"></a><a href="#"><img src="/eshop/Public/Home/images/56985dc0Nda320512.jpg"></a>
						</div>
					</div>
				</div>
				<div class="fore-3">
					...
					<div class="font-item1">
						...
						<div class="font-right">
							<div>
								<a href="#"><img src="/eshop/Public/Home/images/562f4971Na5379aba.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9eef9N5bb8d27f.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef02N99d26435.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef10Nd206a236.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef10Nd206a236.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef10Nd206a236.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef10Nd206a236.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef10Nd206a236.jpg"></a>
						...
						<div class="font-righty">
							<a href="#"><img src="/eshop/Public/Home/images/5673a854N10856704.jpg"></a>
							<a href="#"><img src="/eshop/Public/Home/images/56a0376aN7de1bdcf.jpg"></a>
						</div>
					</div>
				</div>
				<div class="fore-4">
					...
					<div class="font-item1">
						...
						<div class="font-right">
							<div>
								...
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef02N99d26435.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef10Nd206a236.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef28N00328d44.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef34N7cc61f4c.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef3eN99aef1f0.jpg"></a>
								<a href="#"><img src="/eshop/Public/Home/images/54d9ef4cN4fe57f9b.jpg"></a>
							</div>
						</div>
						<div class="font-righty">
							<a href="#"><img src="/eshop/Public/Home/images/5673a854N10856704.jpg"></a>
			...
			<div id="lunbo">
				<ul id="one">
					<li><a href=""><img src="/eshop/Public/Home/images/5690b6dcNd5aaa0f0.jpg"></a></li>
					<li><a href=""><img src="/eshop/Public/Home/images/56960e10N27e2d29f.jpg"></a></li>
					<li><a href=""><img src="/eshop/Public/Home/images/5698a5aaN08e09475.jpg"></a></li>
					<li><a href=""><img src="/eshop/Public/Home/images/56a05078N6add136b.jpg"></a></li>
					<li><a href=""><img src="/eshop/Public/Home/images/56a09e6aN373313d9.jpg"></a></li>
				</ul>
				<ul id="two">
					<li class="on">1</li>
					<li>2</li>
			...
			<div class="ms">
				...
				<div class="mmm">
					<ul>
						<li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat;"></i>
								<span class="ci-bottom">话费</span>
							</a>
						</li>
						<li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat 0 -25px;"></i>
								<span class="ci-bottom">机票</span>
							</a>
						</li>
						<li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat 0 -50px;"></i>
								<span class="ci-bottom">电影票</span>
							</a>
						</li><li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat 0 -75px;"></i>
								<span class="ci-bottom">游戏</span>
							</a>
						</li>
						<li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat -25px -100px;"></i>
								<span class="ci-bottom">彩票</span>
							</a>
						</li>
						<li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat -25px -125px;"></i>
								<span class="ci-bottom">团购</span>
							</a>
						</li>
						<li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat -25px -150px;"></i>
								<span class="ci-bottom">酒店</span>
							</a>
						</li><li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat -25px -175px;"></i>
								<span class="ci-bottom">火车票</span>
							</a>
						</li>
						<li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat 0px -250px;"></i>
								<span class="ci-bottom">众筹</span>
							</a>
						</li>
						<li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat -25px -200px;"></i>
								<span class="ci-bottom">理财</span>
							</a>
						</li>
						<li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat -25px -275px;"></i>
								<span class="ci-bottom">礼品卡</span>
							</a>
						</li><li>
							<a href="">
								<i class="ci-left" style="background:url(/eshop/Public/Home/images/568dfdbdN4f7d7ca3.png)no-repeat -25px -225px;"></i>
		...
		<div id="todays" class="clearfix">
			<div class="" clstag="h|keycount|2015|11a" style="cursor: pointer;">
				<div class="jd-clock-wrap">
					<img src="/eshop/Public/Home/images/dp.png" alt="">
				</div>
			</div>
			<div class="slider clearfix" style="position: relative;">
				<ul class="slider-main" data-lazyload-fn="done" style="width: 6000px;  position: absolute;">
					<li class="slider-panel fore4" style="float: left; display: list-item;" data-switchable-clone="1">
						<div class="fore1">
							<a href="#">
							<img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56cc2972Nd3c58b17.jpg" class=""> 
							</a>
						</div>
						<div class="fore2">
							<a href="#">
							<img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56cc2a94Ne97db95a.jpg" class=""> 
							</a>
						</div>
						<div class="fore3">
							<a href="#"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/5510d809N70c3eb71.jpg" class=""> </a>
						</div>
						<div class="fore4">
							<a href="#"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56cd812eNa0c82edd.jpg" class=""> </a>
						</div>
					</li>
					<li class="slider-panel fore1 ui-switchable-panel-selected" style="float: left; display: list-item;">
						<div class="fore1">
							<a href="http://sale.jd.com/act/Vqp7nHAzGeckZ.html" target="_blank"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56c6d8ccN7258f6ab.jpg" class=""> </a>
						</div>
						<div class="fore2" data-source="2" clstag="h|keycount|2015|11c02">
							<a href="#"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56cd14b3N935ecf9b.jpg" class=""> </a>
						</div>
						<div class="fore3" data-source="2" clstag="h|keycount|2015|11c03">
							<a href="#"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56cab9a6N0691903e.jpg" class=""> </a>
						</div>
						<div class="fore4" data-source="2" clstag="h|keycount|2015|11c04">
							<a href="#"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56ce9dceN61e549d4.jpg" class=""> </a>
						</div>
					</li>
					<li class="slider-panel fore2" style="float: left; display: list-item;">
						<div class="fore1" >
							<a href="http://sale.jd.com/act/YKS1i2oRLqmsU.html" target="_blank"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56c67930Nc3e724b8.jpg" class=""> </a>
						</div>
						<div class="fore2" >
							<a href="http://sale.jd.com/act/vMYwIuKVdfe87.html" target="_blank"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56c6d936N0b16afd4.jpg" class=""> </a>
						</div>
						<div class="fore3" data-source="3" clstag="h|keycount|2015|11c07">
							<a href="#"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56c6b8b3Nfc9e3f91.jpg" class=""> </a>
						</div>
						<div class="fore4" data-source="3" clstag="h|keycount|2015|11c08">
							<a href="#"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56c2d4f5Nb5b12e5e.jpg" class=""> </a>
						</div>
					</li>
					<li class="slider-panel fore3" style="float: left; display: list-item;">
						<div class="fore1">
						<a href="http://sale.jd.hk/act/u1vSna0HGNRA.html" target="_blank"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56cbfe05N09f9352a.jpg" class=""> </a>
						</div>
						<div class="fore2" >
							<a href="http://sale.jd.com/act/TPZF5wv6EJRCYh.html" target="_blank"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56c6bfefN0f89bdde.jpg" class=""> </a>
						</div>
						<div class="fore3" data-source="3" clstag="h|keycount|2015|11c11">
							<a href="#"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56cc3414N0ef21671.jpg" class=""> </a>
						</div>
						<div class="fore4" data-source="3" clstag="h|keycount|2015|11c12">
							<a href="#"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/5510e394N7d91092f.jpg" class=""> </a>
						</div>
					</li>
					<li class="slider-panel fore4" style="float: left; display: list-item;">
						<div class="fore1" >
							<a href="http://sale.jd.com/act/tH03KyMOp81a.html" target="_blank"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56cc2972Nd3c58b17.jpg" class=""> </a>
						</div>
						<div class="fore2" >
							<a href="http://sale.jd.com/act/RwqDGsKQO7Nt.html" target="_blank"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56cc2a94Ne97db95a.jpg" class=""> </a>
						</div>
					...
					<li class="slider-panel fore1" style="float: left; display: list-item;" data-switchable-clone="1">
						<div class="fore1" ><a href="http://sale.jd.com/act/Vqp7nHAzGeckZ.html" target="_blank"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56c6d8ccN7258f6ab.jpg" class=""> </a>
						</div>
						<div class="fore2" data-source="2" clstag="h|keycount|2015|11c02">
							<a href="#"><img data-lazy-img="done" width="250" height="164" src="/eshop/Public/Home/images/56cd14b3N935ecf9b.jpg" class=""> </a>
						</div>
		...
		<div id="guessyou" class="">
			...
			<div class="list1">
				...
				<ul>        
					<li class="fore1">            
						<div class="p-img">
							<a href="#" target="_blank">
								<img data-lazy-img="done" width="130" height="130" title="小米（MI）红米note3 双卡双待 智能 手机 金色 全网通高配版(3G RAM+32G ROM)标配" src="/eshop/Public/Home/images/56543327N1ecaef4f.jpg" class="">
							</a>
						</div>                
						<div class="p-info">                
							<div class="p-name">
					...
					<li class="fore2">            
						<div class="p-img">
							<a href="#" target="_blank"><img data-lazy-img="done" width="130" height="130" title="小米4 移动合约版 黑色 移动4G手机 不含合约计划" src="/eshop/Public/Home/images/555affefN75bf81ed.jpg" class=""></a>
						</div>                
						<div class="p-info">                
					...
					<li class="fore3">            
						<div class="p-img"><a href="#" target="_blank"><img data-lazy-img="done" width="130" height="130" title="勾勾手 重力方向盘无线遥控车 儿童玩具车汽车模型 漂移遥控汽车 可充电 急速游侠 红色" src="/eshop/Public/Home/images/55376141Na63cbc04.jpg" class=""></a>
						</div>                
						<div class="p-info">                
					...
					<li class="fore4">            
						<div class="p-img">
							<a href="#" target="_blank"><img data-lazy-img="done" width="130" height="130" title="【明星同款 年终清仓】吉普盾NIAN JEEP男女情侣款两件套三合一冲锋衣防水防风保暖 男款灰色 M" src="/eshop/Public/Home/images/56849f79N5041bd59.jpg" class=""></a>
						</div>                
						<div class="p-info">                
					...
					<li class="fore5">            
						<div class="p-img">
							<a href="#" target="_blank"><img data-lazy-img="done" width="130" height="130" title="小米（MI）小米蓝牙耳机-黑色 " src="/eshop/Public/Home/images/55d17800N1b88605f.jpg" class=""></a>
						</div>                
						<div class="p-info">                
							<div class="p-name">
					...
					<li class="fore6">            
						<div class="p-img">
							<a href="#" target="_blank"><img data-lazy-img="done" width="130" height="130" title="SSC汽车高压洗车机高压清洗机家用220v洗车器洗车泵1616d" src="/eshop/Public/Home/images/568cbdcbNac6d0772.jpg" class=""></a>
						</div>                
						<div class="p-info">                
							<div class="p-name">
			...
			<div class="hs-content" style="position: relative;">		        
				<div class="has-col1">		            
					<a target="_blank" href="#" class="has-item">		                
						...
						<img src="/eshop/Public/Home/images/56ce76b3N70dd538b.jpg">		            
					</a>		            
					<a target="_blank" href="#" class="has-item-small">		                
						...
						<img src="/eshop/Public/Home/images/56cd90b9N0a81f09c.jpg">		            
					</a>		            
					<a target="_blank" href="http://xinpin.jd.com/new.html" class="has-item-small">		                
						<div class="sub-tit">		                    
							...
							<img src="/eshop/Public/Home/images/56ce6b9aN1c2ecedd.jpg">		            
						</a>		        
					</div>		        
					<div class="has-col2">		            
						<a clstag="h|keycount|2015|13c" target="_blank" href="http://hao.jd.com/" class="has-item">		                
							...
							<img src="/eshop/Public/Home/images/56cfe74fN656e8551.jpg">		            
						</a>		            
						<a target="_blank" href="#" class="has-item-small">		          
							<div class="sub-tit">		                    
								<p class="tit">潮有范</p>		                    
							...
							<img src="/eshop/Public/Home/images/56cecc2cNef8bb127.jpg">		            
						</a>		        
					</div>		        
					<div class="has-col3">		            
						<a clstag="h|keycount|2015|13a" target="_blank" href="#" class="has-item">		                
							...
							<img src="/eshop/Public/Home/images/56ce9ccdN3edefcbe.jpg">		            
						</a>		            
						<a target="_blank" href="#" class="has-item-small">		                
							<div class="sub-tit">		                    
								<p class="tit">国际大牌</p>		                    
							...
							<img src="/eshop/Public/Home/images/56cd517eN00f8b4b9.jpg">		            
						</a>		            
						<a target="_blank" href="#" class="has-item-small">		                
							<div class="sub-tit">		                    
								<p class="tit">科技精品</p>		                    
							...
							<img src="/eshop/Public/Home/images/56cec008N62a33530 (1).jpg">		            
						</a>		        
					</div>		        
					<div class="hs-brands">		            
						<div class="brands-left">		                
							<ul>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56c6e9f8N4dbb9d82.jpg"></a>
								</li>
								<li>
									<a class="item">
										<img src="/eshop/Public/Home/images/56cfc8ecN4e1be163.jpg"></a>
								</li>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56cad6bbNfb26d292.jpg">
									</a>
								</li>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56cad7d2N1874563f.jpg">
									</a>
								</li>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56c6e6d1N5ca75add.jpg">
									</a>
								</li>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56cad981N823d9db6.jpg">
									</a>
								</li>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56cad9bfN2f47ae16.jpg">
									</a>
								</li>
							</ul>		            
						</div>		            
						<div class="brands-right">		                
							<ul>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56c6e93aNbe80cb1b.jpg">
									</a>
								</li>
								<li>
									<a  href="#" class="item"><img src="/eshop/Public/Home/images/56cad85aNcbcc9dd3.jpg">
									</a>
								</li>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56cada49N382d2e2c.jpg"></a>
								</li>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56c6e872Nb185d562.jpg">
									</a>
								</li>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56c6e7eeN5b058659.jpg">
									</a>
								</li>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56c6ea8aN2c6a427d.jpg">
									</a>
								</li>
								<li>
									<a href="#" class="item"><img src="/eshop/Public/Home/images/56cad903N7a43faa0.jpg">
									</a>
								</li>
							</ul>		            
						</div>		        
					</div>		    
					<a clstag="h|keycount|2015|13w" id="jd_chaojidapai" style="position: absolute; right: 172px; top: 0; display: block; overflow: hidden; width: 403px; height: 405px;" target="_blank" href="#"><img src="/eshop/Public/Home/images/56cfb194N1f7db68f.jpg">
					</a>
					<span class="hidein">x</span>
				</div>		
			</div>
			<div class="footer-banner-1">
				<img src="/eshop/Public/Home/images/kx.png" alt="">
			</div>
		...
		<div class="side" style="display:block;">
			<div class="side-inner">
				<div class="banner" clstag="h|keycount|2015|17a1">
					<!-- 2_955_6219 
						<a href="#" title="" target="_blank"><img src="Public/Home/images/56d03188N199b8851.jpg" width="330" height="475" alt="" fclog="0.100158.166065.1.2_955_6219"></a>-->
			...
			<div class="side-extra">
				<!-- 2_955_6307 -->
				<a href="#"><img width="328" height="157" src="/eshop/Public/Home/images/56ce6bcfNd798dc48.jpg"></a>
		...
		<div class="main main-selected" style="display: block;">
			<div class="main-inner">
				<ul class="main-body">
					...
					<li class="fore1" >
						<a target="_blank" href="#"><img src="/eshop/Public/Home/images/56cdc35aNec4e4ce4.jpg" width="439" height="157"></a>
					</li>
					<li class="fore2" id="f1-fore-random">
						<a target="_blank" href="#">
							<img src="/eshop/Public/Home/images/56cdd2feN2c24c538.jpg" width="439" height="157">
						</a>
					</li>
					<li class="fore3" >
						<a target="_blank" href="#">
							<img src="/eshop/Public/Home/images/56cdc486N8446aa1b.jpg" width="219" height="157">
						</a>
					</li>
					<li class="fore4">
						<a target="_blank" href="#"><img src="/eshop/Public/Home/images/56cdc49bNa08f3286.jpg" width="219" height="157">
						</a>
					</li>
					<li class="fore5" >
						<a target="_blank" href="#"><img src="/eshop/Public/Home/images/56cfc9dcN436c0d1a.jpg" width="219" height="157"></a>
					</li>
					<li class="fore6" >
						<a target="_blank" href="#"><img src="/eshop/Public/Home/images/56cdc4b9N85fdfe94.jpg" width="219" height="157"></a>
					</li>
				</ul>
				<ul class="main-extra">
					
						<li class="fore1">
								<a target="_blank" href="#"><img src="/eshop/Public/Home/images/56cdc4d9N0afa1def.jpg" width="219" height="157"></a>
						</li>
						<li class="fore2">
								<a target="_blank" href="#"><img src="/eshop/Public/Home/images/56cdc4f0N65dd79c3.jpg" width="219" height="157"></a>
						</li>
					<li class="fore3">
						<!-- 广告位 2_955_6821-->
						<div id="ad6821"><a href="#"><img src="/eshop/Public/Home/images/56cfca73N8fa61e5a.jpg" width="219" height="316"></a></div>
					</li>
				</ul>
			</div>
			<div class="slider">
	...
	<div class="slider-body" style="position: relative;">
		<ul class="slider-main1" style="width: 2634px; left: -439px; position: absolute;">
			<li class="slider-panel" style="float: left; display: list-item;">
				<a href="#"><img src="/eshop/Public/Home/images/56cdc44dN5d0f942d.jpg" width="439" height="315" data-lazy-img="done" alt=""></a>
			</li>
			<li class="slider-panel slider-panel-selected" style="float: left; display: list-item;">
				<a href="#"><img src="/eshop/Public/Home/images/56cdc3c0N2d556f4f.jpg" width="439" height="315" alt=""></a>
			</li>
			<li class="slider-panel" style="float: left; display: list-item;">
				<a href="#"><img src="/eshop/Public/Home/images/56cdc3e5N16ad9ec8.jpg" width="439" height="315" data-lazy-img="done" alt=""></a>
			</li>
			<li class="slider-panel" style="float: left; display: list-item;">
				<a href="#"><img src="/eshop/Public/Home/images/56cdc416Ne54f9cd9.jpg" width="439" height="315" alt=""></a>
			</li>
			<li class="slider-panel" style="float: left; display: list-item;">
				<a href="#" target="_blank" title=""><img src="/eshop/Public/Home/images/56cdc44dN5d0f942d.jpg" width="439" height="315" alt=""></a></li>
		<li class="slider-panel" style="float: left; display: list-item;">
			<a href="#"><img src="/eshop/Public/Home/images/56cdc3c0N2d556f4f.jpg" width="439" height="315" alt=""></a>
		</li>
	</ul>
	...
	<div class="main hide" style="display: none;">     
		<ul class="p-list">                                 
			<li class="fore1" clstag="h|keycount|2015|17c01">        
				<div class="p-img">         
					<a target="_blank" href="http://item.jd.com/1478913544.html" title="哈吉斯 春装新品男士细条纹纯棉长袖T恤">          
						<img width="130" height="130" alt="哈吉斯 春装新品男士细条纹纯棉长袖T恤" src="/eshop/Public/Home/images/56c3cd4bN71e351e0.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore2">        
				<div class="p-img">         
					<a target="_blank" href="#" title="罗蒙男士长袖衬衫牛津纺白衬衣 浅蓝">
						<img width="130" height="130" alt="罗蒙男士长袖衬衫牛津纺白衬衣 浅蓝" src="/eshop/Public/Home/images/56c3d620N490baa1e.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore3" clstag="h|keycount|2015|17c03">        
				<div class="p-img">         
					<a target="_blank" href="#" title="美特斯邦威男棒球服针织开衫影黑">          
						<img width="130" height="130" alt="美特斯邦威男棒球服针织开衫影黑" src="/eshop/Public/Home/images/55f01a0bN82bbb274.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore4" clstag="h|keycount|2015|17c04">        
				<div class="p-img">         
					<a target="_blank" href="#" title="马克华菲 新款精致长袖衬衫 时尚印花拼接衬衫">          
						<img width="130" height="130" alt="马克华菲 新款精致长袖衬衫 时尚印花拼接衬衫" src="/eshop/Public/Home/images/55e66654N8ff7c28b.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore5" clstag="h|keycount|2015|17c05">        
				<div class="p-img">         
					<a target="_blank" href="http://item.jd.com/1610518006.html" title="思莱德 修身微弹混纺男士休闲西裤">          
						<img width="130" height="130" alt="思莱德 修身微弹混纺男士休闲西裤" src="/eshop/Public/Home/images/56c3e812Nf2dc2626.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore6" clstag="h|keycount|2015|17c06">        
				<div class="p-img">         
					<a target="_blank" href="#" title="威可多 男士商务正装舒适西裤">          <img width="130" height="130" alt="威可多 男士商务正装舒适西裤" src="/eshop/Public/Home/images/56551775Naa32394e.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore7" clstag="h|keycount|2015|17c07">        
				<div class="p-img">         
					<a target="_blank" href="#" title="森马休闲裤  男士中低腰宽松小脚针织卫裤">          <img width="130" height="130" alt="森马休闲裤  男士中低腰宽松小脚针织卫裤" src="/eshop/Public/Home/images/56a1a0a7Ncc046daa.png">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore8" clstag="h|keycount|2015|17c08">        
				<div class="p-img">         
					<a target="_blank" href="#" title="九牧王 男士免烫长裤商务休闲西裤">
						<img width="130" height="130" alt="九牧王 男士免烫长裤商务休闲西裤" src="/eshop/Public/Home/images/56cd590cNb72d5153.jpg">         
					</a>        
				</div>        
		...
		<ul class="img-list">                                 
			<li class="fore1" >        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc802Ne2d2904c.jpg">        
				</a>       
			</li>                           
			<li class="fore2" clstag="h|keycount|2015|17cb">        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc812N28b5f894.jpg">        
				</a>       
			</li>                           
			<li class="fore3" >        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc822N62394473.jpg">        
				</a>       
			</li>                           
			<li class="fore4" clstag="h|keycount|2015|17cd">        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56ceb62fN83f1fdc1.jpg">        
				</a>       
			</li>                  
		</ul>    
	</div>
	<div class="main hide" style="display: none;">     
		<ul class="p-list">                                 
			<li class="fore1">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="#" src="/eshop/Public/Home/images/56c2e5cfN6b73e3c7.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore2" clstag="h|keycount|2015|17d02">        
				<div class="p-img">         
					<a target="_blank" href="#" title="玛丝菲尔 优雅高贵垂褶真丝连衣裙">          <img width="130" height="130" alt="玛丝菲尔 优雅高贵垂褶真丝连衣裙" src="/eshop/Public/Home/images/56c66db0N8ddea872.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore3" clstag="h|keycount|2015|17d03">        
				<div class="p-img">         
					<a target="_blank" href="#" title="谜底女装 简约百搭纯棉净色长袖衬衣衬衫">          
						<img width="130" height="130" alt="谜底女装 简约百搭纯棉净色长袖衬衣衬衫" src="/eshop/Public/Home/images/56cd0dd0N5e9c08d1.jpg">         
					</a>        
				</div>        
			...
			<li class="fore4">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd5f86N8529d98f.jpg">
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore5">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd2e49N7f87599e.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore7">        
				<div class="p-img">         
					<a target="_blank" href="#">          
						<img width="130" height="130" alt="艾格 S纯色v领休闲衬衫 本白色" src="/eshop/Public/Home/images/56cd3ce5N0ffc07aa.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore8">        
				<div class="p-img">         
					<a target="_blank" href="#">          
						<img width="130" height="130" alt="伊芙丽 黑色中长款马夹女无袖女马甲" src="/eshop/Public/Home/images/56ce6b96N5a787545.jpg">         
					</a>        
				</div>        
				<div class="p-name">
		...
		<ul class="img-list">                                 
			<li class="fore1">        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc85cNe276d8d8.jpg">        
				</a>       
			</li>                           
			<li class="fore2">        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc86fNa9c068c8.jpg">        
				</a>       
			</li>                           
			<li class="fore3" >        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc88cNbd815400.jpg">        
				</a>       
			</li>                           
			<li class="fore4" >        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc8a6N350655a8.jpg">        
				</a>       
			</li>                  
		</ul>    
	</div>
	<div class="main hide" style="display: none;">     
		<ul class="p-list">                                 
			<li class="fore1">        
				<div class="p-img">         
					<a target="_blank" href="" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd0d51Ne7151f30.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore2">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/568f2e35Ned561196.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore3" clstag="h|keycount|2015|17e03">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd1a03Ndf274314.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore4">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/5599fb75Nf07c441e.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore5">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd4877Na4a41ee2.jpg">         
					</a>        
				</div>        
			...
			<li class="fore6">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd1b4bN3aff6da1.jpg">         
					</a>        
				</div>        
			...
			<li class="fore7" >        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56d01d68N03d8878e.jpg">         
					</a>        
				</div>        
			...
			<li class="fore8">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/569373bbNc10ab40c.jpg">         
					</a>        
				</div>        
				<div class="p-name">
		...
		<ul class="img-list">                                 
			<li class="fore1">        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc8ccNd67aa507.jpg">        
				</a>       
			</li>                           
			<li class="fore2">        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc8deN674f0ef7.jpg">        
				</a>       
			</li>                           
			<li class="fore3">        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc8f3N14a972ad.jpg">        
				</a>       
			</li>                           
			<li class="fore4" >        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc906Na4b1ff7c.jpg">        
				</a>       
			</li>                  
		</ul>    
	</div>
	<div class="main hide" style="display: none;">     
		<ul class="p-list">                                 
			<li class="fore1" clstag="h|keycount|2015|17f01">        
				<div class="p-img">         
					<a target="_blank" href="http://item.jd.com/1775904401.html" title="美国POLO 商务尼龙牛皮单肩斜挎包">          
						<img width="130" height="130" alt="美国POLO 商务尼龙牛皮单肩斜挎包" src="/eshop/Public/Home/images/56cd0f6bN9f76b283.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore2">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd0fe5Nfe1b19d8.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore3">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd0e46Ne231fb2e.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore4" clstag="h|keycount|2015|17f04">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd33b9N7c88ba30.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore5" >        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/562adfbfN33934ec3.jpg">         
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore6" >        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd1d49Nc30cdb3b.jpg">
					</a>        
				</div>        
				<div class="p-name">
			...
			<li class="fore7">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd52a0Nae78cd2b.jpg">         
					</a>        
				</div>        
			...
			<li class="fore8">        
				<div class="p-img">         
					<a target="_blank" href="#" title="">          
						<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd1044N5063ea54.jpg">         
					</a>        
				</div>        
		...
		<ul class="img-list">                                 
			<li class="fore1" >        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc944N4f9497d4.jpg">        
				</a>       
			</li>                           
			<li class="fore2" >        
				<a target="_blank" href="#">         
					<img width="219" height="157" src="/eshop/Public/Home/images/56cdc956Na8d6ef06.jpg">        
				</a>       
			</li>                           
				<li class="fore3" clstag="h|keycount|2015|17fc">        
					<a target="_blank" href="#">         
						<img width="219" height="157" src="/eshop/Public/Home/images/56cdc966N3b48164b.jpg">       
					</a>       
				</li>                           
				<li class="fore4" >        
					<a target="_blank" href="#">         
						<img width="219" height="157" src="/eshop/Public/Home/images/56cdc97aN3e1b0fe9.jpg">        
					</a>       
				</li>                  
			</ul>    
		</div>
		<div class="main hide" style="display: none;">     
			<ul class="p-list">                                 
				<li class="fore1" >        
					<div class="p-img">         
						<a target="_blank" href="#" title="">
							<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd515bN99606e05.jpg">         
						</a>        
					</div>        
				...
				<li class="fore2" >        
					<div class="p-img">         
						<a target="_blank" href="#" title="">          
							<img width="130" height="130" alt="" src="/eshop/Public/Home/images/561b4309Nd3108493.jpg">         
						</a>        
					</div>        
				...
				<li class="fore3" >        
					<div class="p-img">         
						<a target="_blank" href="#" title="">          
							<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd14a1N5e921d81.jpg">         
						</a>        
					</div>        
					<div class="p-name">
				...
				<li class="fore4">        
					<div class="p-img">         
						<a target="_blank" href="#" title="">          
							<img width="130" height="130" alt="" src="/eshop/Public/Home/images/5519fdacN4d0ae69b.jpg">         </a>        
						</div>        
						<div class="p-name">
					...
					<li class="fore5">        
						<div class="p-img">         
							<a target="_blank" href="#" title="">          
								<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56cd2e49N909acb24.jpg">         
							</a>        
						</div>        
						<div class="p-name">
					...
					<li class="fore6" clstag="h|keycount|2015|17g06">        
						<div class="p-img">         
							<a target="_blank" href="#" title="">          
								<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56775ae2Ndd3c502b.jpg">         
							</a>        
						</div>        
						<div class="p-name">
					...
					<li class="fore7" clstag="h|keycount|2015|17g07">        
						<div class="p-img">         
							<a target="_blank" href="#" title="秋鹿 男士民族风套头长袖家居服套装">          
								<img width="130" height="130" alt="秋鹿 男士民族风套头长袖家居服套装" src="/eshop/Public/Home/images/56cd1a6dN0e10e8b7.jpg">         
							</a>        
						</div>        
						<div class="p-name">
					...
					<li class="fore8" clstag="h|keycount|2015|17g08">        
						<div class="p-img">         
							<a target="_blank" href="#" title="北极绒男士袜子男 精梳棉中筒休闲商务袜">          
								<img width="130" height="130" alt="北极绒男士袜子男 精梳棉中筒休闲商务袜" src="/eshop/Public/Home/images/56cd5504N29a0036d.jpg">         
							</a>        
						</div>        
				...
				<ul class="img-list">                                 
					<li class="fore1" clstag="h|keycount|2015|17ga">        
						<a target="_blank" href="#">         
							<img width="219" height="157" src="/eshop/Public/Home/images/56cdc99cN4291a808.jpg">        
						</a>       
					</li>                           
					<li class="fore2" clstag="h|keycount|2015|17gb">        
						<a target="_blank" href="#">         
							<img width="219" height="157" src="/eshop/Public/Home/images/56cdc9b1N6faec9c6.jpg">        
						</a>       
					</li>                           
					<li class="fore3" clstag="h|keycount|2015|17gc">        
						<a target="_blank" href="#">         
							<img width="219" height="157" src="/eshop/Public/Home/images/56cdc9c4Naac6a4e7.jpg">        
						</a>       
					</li>                           
					<li class="fore4" clstag="h|keycount|2015|17gd">        
						<a target="_blank" href="#">         
							<img width="219" height="157" src="/eshop/Public/Home/images/56cdc9d6N37c6d2c7.jpg">        
						</a>       
					</li>                  
				</ul>    
			</div>
			<div class="main hide" style="display: none;">     
				<ul class="p-list">                                 
					<li class="fore1" clstag="h|keycount|2015|17h01">        
						<div class="p-img">         
							<a target="_blank" href="http://item.jd.com/1616669573.html" title="梵玺 开光黑曜石八大守护神吊坠">          
								<img width="130" height="130" alt="梵玺 开光黑曜石八大守护神吊坠" src="/eshop/Public/Home/images/56c3e0e6Ne569d4d0.jpg">         
							</a>        
						</div>        
					...
					<li class="fore2" clstag="h|keycount|2015|17h02">        
						<div class="p-img">         
							<a target="_blank" href="#" title="缤纷美饰 18K金镶钻大溪地黑珍珠吊坠">          
								<img width="130" height="130" alt="缤纷美饰 18K金镶钻大溪地黑珍珠吊坠" src="/eshop/Public/Home/images/54b38532N02a8bb27.jpg">         
							</a>        
						</div>        
						<div class="p-name">
					...
					<li class="fore3">        
						<div class="p-img">         
							<a target="_blank" href="#" title="">          
								<img width="130" height="130" alt="中国黄金 Au9999薄片财富投资金条10g" src="/eshop/Public/Home/images/56721972N0f9d060f.jpg">         
							</a>        
						</div>        
						<div class="p-name">
					...
					<li class="fore4">        
						<div class="p-img">         
							<a target="_blank" href="#" title="周大生 黄金吊坠 精巧时尚足金猴猴吊坠">          
								<img width="130" height="130" alt="周大生 黄金吊坠 精巧时尚足金猴猴吊坠" src="/eshop/Public/Home/images/568cce53N5cddee4c.jpg">         
							</a>        
						</div>        
						<div class="p-name">
					...
					<li class="fore5" >        
						<div class="p-img">         
							<a target="_blank" href="#" title="埃菲尔铁塔钻戒女18K求婚结婚钻石戒指">          
								<img width="130" height="130" alt="埃菲尔铁塔钻戒女18K求婚结婚钻石戒指" src="/eshop/Public/Home/images/56a82e9dNac60381a.jpg">         
							</a>        
						</div>        
					...
					<li class="fore6" clstag="h|keycount|2015|17h06">        
						<div class="p-img">         
							<a target="_blank" href="#" title="">          
								<img width="130" height="130" alt="TORIGHT S925银项链 女吊坠锁骨链银饰品" src="/eshop/Public/Home/images/56a59ddcN7edfe4ec.jpg">         </a>        
							</div>        
							<div class="p-name">
						...
						<li class="fore7" clstag="h|keycount|2015|17h07">        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="" src="/eshop/Public/Home/images/56a5cea1Nbec4d323.jpg">         
								</a>        
							</div>        
						...
						<li class="fore8" >        
							<div class="p-img">         
								<a target="_blank" href="#" title="钻石小鸟 18K玫瑰金钻石套链主石约5分">          
									<img width="130" height="130" alt="钻石小鸟 18K玫瑰金钻石套链主石约5分" src="/eshop/Public/Home/images/56a601e6N17c530f9.jpg">         
								</a>        
							</div>        
					...
					<ul class="img-list">                                 
						<li class="fore1" >        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdca25N8aa1cbb6.jpg">        
							</a>       
						</li>                           
						<li class="fore2" >        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdca36N6e25e29a.jpg">        
							</a>       
						</li>                           
						<li class="fore3" >        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdca47N91c932f8.jpg">

							</a>       
						</li>                           
						<li class="fore4" >        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdca56N482d9c47.jpg">        
							</a>       
						</li>                  
					</ul>    
				</div>
				<div class="main hide" style="display: none;">     
					<ul class="p-list">                                 
						<li class="fore1" clstag="h|keycount|2015|17i01">        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="迈克·科尔斯 铆钉装饰牛皮中号手提单肩斜挎包" src="/eshop/Public/Home/images/55fa63a2N2e319d4c.jpg">         
								</a>        
							</div>        
							<div class="p-name">
						...
						<li class="fore2" >        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="巴宝莉 女士经典格纹小牛皮手提包" src="/eshop/Public/Home/images/56690becN61c5a974.jpg">         
								</a>        
							</div>        
						...
						<li class="fore3" >        
							<div class="p-img">         
								<a target="_blank" href="#">         
									<img width="130" height="130" alt="fILOFAX 英国活页万用手册手账 活页本" src="/eshop/Public/Home/images/56cd56bcN83e28801.jpg">         
								</a>        
							</div>        
						...
						<li class="fore4" clstag="h|keycount|2015|17i04">        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="春舞枝 鲜花速递 生日祝福鲜花 创意礼品" src="/eshop/Public/Home/images/56a9c5d8Ndf2dcc91.jpg">         
								</a>        
							</div>        
						...
						<li class="fore5" >        
							<div class="p-img">         
								<a target="_blank" href="#" title="特唯普进口电子烟套装 英国戒烟器产品 臻烟">          
									<img width="130" height="130" alt="特唯普进口电子烟套装 英国戒烟器产品 臻烟" src="/eshop/Public/Home/images/56779e2aN8b2baae0.jpg">         
								</a>        
							</div>        
						...
						<li class="fore6" >        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="全球购 施华洛世奇 镀白金色LOVE项链" src="/eshop/Public/Home/images/55cddb80N4abbccc6.jpg">         
								</a>        
							</div>        
							<div class="p-name">
						...
						<li class="fore7" >        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="上海集藏 中国金币2016年熊猫金银纪念币" src="/eshop/Public/Home/images/55e7f912Ndcab42dc.jpg">         
								</a>        
							</div>        
						...
						<li class="fore8" >        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="巴宝莉 男士翻领休闲商务POLO衫T恤上衣" src="/eshop/Public/Home/images/56cd1a16N99cce67b.jpg">         
								</a>        
							</div>        
					...
					<ul class="img-list">                                 
						<li class="fore1" >        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdca78Nce3a45cc.jpg">        
							</a>       
						</li>                           
						<li class="fore2" >        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdca8dNc0da3888.jpg">        
							</a>       
						</li>                           
						<li class="fore3" >        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdca9eN5a1c2c29.jpg">        
							</a>       
						</li>                           
						<li class="fore4" >        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdcab1Na0be98f4.jpg">        
							</a>       
						</li>                  
					</ul>    
				</div>
				<div class="main hide" style="display: none;">     
					<ul class="p-list">                                 
						<li class="fore1" clstag="h|keycount|2015|17j01">        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="海鸥 手表 多功能飞轮系列双历自动机械男表" src="/eshop/Public/Home/images/rBEbRVOETfIIAAAAAAGBh4yU1ZMAACVbQHNVhQAAYGf626.jpg">         
								</a>        
							</div>        
							<div class="p-name">
						...
						<li class="fore2" >        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="西铁城手表 光动能不锈钢表带男表" src="/eshop/Public/Home/images/56a86b7fNb55bd756.jpg">         
								</a>        
							</div>        
						...
						<li class="fore3" clstag="h|keycount|2015|17j03">        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="天梭(TISSOT)手表 经典系列机械男表" src="/eshop/Public/Home/images/55643863N466e4037.jpg">         
								</a>        
							</div>        
						...
						<li class="fore4" >        
							<div class="p-img">         
								<a target="_blank" href="#" title="浪琴(Longines)手表 名匠系列机械男表">          
									<img width="130" height="130" alt="浪琴(Longines)手表 名匠系列机械男表" src="/eshop/Public/Home/images/54d999c1N7d70c4ae.jpg">         
								</a>        
							</div>        
							<div class="p-name">
						...
						<li class="fore5" clstag="h|keycount|2015|17j05">        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="依波手表 夏洛克系列时尚自动个性机械女表" src="/eshop/Public/Home/images/559f91cdNdb618ee8.jpg">         
								</a>        
							</div>        
						...
						<li class="fore6" clstag="h|keycount|2015|17j06">        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="全国联保 卡西欧 手表 Analogue系列" src="/eshop/Public/Home/images/5660211fN04741d75.jpg">         
								</a>        
							</div>        
						...
						<li class="fore7" >        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="尼尚手表 全自动机械表男表" src="/eshop/Public/Home/images/5694a38aNcc7f33c6.jpg">         
								</a>        
							</div>        
						...
						<li class="fore8" clstag="h|keycount|2015|17j08">        
							<div class="p-img">         
								<a target="_blank" href="#">          
									<img width="130" height="130" alt="劳士顿 手链钨钢女表防水防划石英表" src="/eshop/Public/Home/images/5558a0d0Nd54e914d.jpg">         
								</a>        
							</div>        
					...
					<ul class="img-list">                                 
						<li class="fore1" clstag="h|keycount|2015|17ja">        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdcadcN52ca3223.jpg">        
							</a>       
						</li>                           
						<li class="fore2" >        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdcaf4N681cf63c.jpg">        
							</a>       
						</li>                           
						<li class="fore3" >        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdcb05N6119680c.jpg">        
							</a>       
						</li>                           
						<li class="fore4" clstag="h|keycount|2015|17jd">        
							<a target="_blank" href="#">         
								<img width="219" height="157" src="/eshop/Public/Home/images/56cdcb14N2f13c418.jpg">        
							</a>       
						</li>                  
					</ul>    
				</div>
		...
		<div class="brands"style="display:block;">
			<img src="/eshop/Public/Home/images/brounds.png" alt="">
		</div>
<!--index_ok-->
		</div>
		<!--天天特价-->
		...
		<div class="mc">
			<ul>
				...
				<li class="fore1">
				<div class="p-img">
					<a href="#" target="_blank"><img src="/eshop/Public/Home/images/56cd4890Ncb5e42dc.png" width="160" height="160" alt=""></a>
				</div>
				<div class="p-info">
			...
			<li class="fore2">
				<div class="p-img">
					<a href="#" target="_blank"><img src="/eshop/Public/Home/images/56cd606eN2bca1efb.png" width="100" height="100" alt=""></a>
				</div>
				<div class="p-info">
			...
			<li class="fore3">
				<div class="p-img">
					<a href="#" target="_blank"><img src="/eshop/Public/Home/images/56cd6173Nfdc36700.png" width="100" height="100" alt=""></a>
				</div>
				<div class="p-info">
			...
			<li class="fore4" >
				<div class="p-img">
					<a href="#"><img src="/eshop/Public/Home/images/56cd6333Nb7ab172a.png" width="100" height="100" alt=""></a>
				</div>
				<div class="p-info">
			...
			<li class="fore5" clstag="h|keycount|2015|31a5">
				<div class="p-img">
					<a href="#"><img src="/eshop/Public/Home/images/56cd635dNdf30e78b.png" width="100" height="100" alt=""></a>
				</div>
				<div class="p-info">
			...
			<li class="fore6">
				<div class="p-img">
					<a href="#" target="_blank"><img src="/eshop/Public/Home/images/56cd639aNe4e10658.png" width="100" height="100" alt="立客（LIKE）LK-S2011 2.0升 电水壶 全钢防干烧/自动断电"></a>
				</div>
				<div class="p-info">
			...
			<li class="fore7">
				<div class="p-img">
					<a href="#" ><img src="/eshop/Public/Home/images/56d00888Nff020c36.png" width="100" height="100" alt=""></a>
				</div>
				<div class="p-info">
					<div class="p-name">
 ...
 <div class="mc">
	<div class="sw" style="position: relative;">
		<ul style="top: -720px; position: absolute;"><li clstag="h|keycount|2015|31b5" data-switchable-clone="1" style="display: list-item;">
			<div class="p-img">
				<a href="#"><img src="/eshop/Public/Home/images/55d3f67aNc7bd1217.jpg" alt="" width="80" height="80"></a>
			</div>
			<div class="p-info">
				<div class="author-info">
					<img title="JalenChou1" src="/eshop/Public/Home/images/56cfa1c4Nb5d69f89.jpg" alt="JalenChou1" width="28" height="28">
		...
		<li clstag="h|keycount|2015|31b6" data-switchable-clone="1" style="display: list-item;">
			<div class="p-img">
				<a href="#" target="_blank"><img src="/eshop/Public/Home/images/566e3801N5416f870.jpg" alt="电陶炉很好，拆开试了加热很快。" width="80" height="80"></a>
			</div>
			<div class="p-info">
				<div class="author-info">
					<img title="lhm9199" src="/eshop/Public/Home/images/56cfa1ccN3dee9031.jpg" alt="lhm9199" width="28" height="28">
					<span>lhm9199</span>
				</div>
				<div class="p-detail">
		...
		<li style="display: list-item;">
			<div class="p-img">
				<a href="#" target="_blank"><img src="/eshop/Public/Home/images/5668ee98N42fbbfc0.jpg" alt="" width="80" height="80"></a>
			</div>
			<div class="p-info">
				<div class="author-info">
					<img title="zhou-fei" src="/eshop/Public/Home/images/56cfa1a3Ne51145d7.jpg" alt="zhou-fei" width="28" height="28">
					<span>zhou-fei</span>
				</div>
				<div class="p-detail">
		...
		<li style="display: list-item;" class="">
			<div class="p-img">
				<a href="#" target="_blank"><img src="/eshop/Public/Home/images/56273f03N5d252709.jpg" alt="感觉还可以，相信京东" width="80" height="80"></a>
			</div>
			<div class="p-info">
				<div class="author-info">
					<img title="沈洪娟" src="/eshop/Public/Home/images/56cfa1aaNea6b7699.jpg" alt="沈洪娟" width="28" height="28">
					<span>沈洪娟</span>
				</div>
				<div class="p-detail">
		...
		<li style="display: list-item;" class="">
			<div class="p-img">
				<a href="#" target="_blank"><img src="/eshop/Public/Home/images/56c2dd74N1bd18e2b.jpg" alt="台灯买来女儿很开心她说非常好用，京东值得肯定！" width="80" height="80"></a>
			</div>
			<div class="p-info">
				<div class="author-info">
					<img title="微笑xhq66" src="/eshop/Public/Home/images/56cfa1b2N3f8a29be.jpg" alt="微笑xhq66" width="28" height="28">
					<span>微笑xhq66</span>
				</div>
				<div class="p-detail">
		...
		<li style="display: list-item;">
			<div class="p-img">
				<a href="#" target="_blank"><img src="/eshop/Public/Home/images/56580901N2c691a23.jpg" alt="" width="80" height="80"></a>
			</div>
			<div class="p-info">
				<div class="author-info">
					<img src="/eshop/Public/Home/images/56cfa1bbNc1ad9a8a.jpg" alt="药材公司办公室" width="28" height="28">
					<span>药材公司办公室</span>
				</div>
				<div class="p-detail">
		...
		<li class="ui-switchable-panel-selected" style="display: list-item;">
			<div class="p-img">
				<a href="#" target="_blank"><img src="/eshop/Public/Home/images/55d3f67aNc7bd1217.jpg" alt="" width="80" height="80"></a>
			</div>
			<div class="p-info">
				<div class="author-info">
					<img title="JalenChou1" src="/eshop/Public/Home/images/56cfa1c4Nb5d69f89.jpg" alt="JalenChou1" width="28" height="28">
		...
		<li class="" style="display: list-item;">
			<div class="p-img">
				<a href="#" target="_blank"><img src="/eshop/Public/Home/images/566e3801N5416f870.jpg" alt="" width="80" height="80"></a>
			</div>
			<div class="p-info">
				<div class="author-info">
					<img title="lhm9199" src="/eshop/Public/Home/images/56cfa1ccN3dee9031.jpg" alt="lhm9199" width="28" height="28">
...
<!--***********************************************-->
	<div class="lazy-fn lazy-fn-done" id="lazy-footer">        
		<div id="service-2014">
	<div class="slogen">
		 <img src="/eshop/Public/Home/images/duo.png" alt="">
	</div>
	<div class="w">
		<dl class="fore1">
			<dt>购物指南</dt>
	...
	<div id="footer-2014" >
		...
		<div class="copyright">
			<a target="_blank" href="#"><img src="/eshop/Public/Home/images/56a0a994Nf1b662dc.png"> 京公网安备 11000002000088号</a>&nbsp;&nbsp;|&nbsp;&nbsp;京ICP证070359号&nbsp;&nbsp;|&nbsp;&nbsp;<a target="_blank" href="#">互联网药品信息服务资格证编号(京)-经营性-2014-0008</a>&nbsp;&nbsp;|&nbsp;&nbsp;新出发京零&nbsp;字第大120007号<br><a rel="nofollow" href="#" target="_blank">音像制品经营许可证苏宿批005号</a>&nbsp;&nbsp;|&nbsp;&nbsp;出版物经营许可证编号新出发(苏)批字第N-012号&nbsp;&nbsp;|&nbsp;&nbsp;互联网出版许可证编号新出网证(京)字150号<br><a href="#" target="_blank">网络文化经营许可证京网文[2014]2148-348号</a>&nbsp;&nbsp;违法和不良信息举报电话：4006561155&nbsp;&nbsp;Copyright&nbsp;©&nbsp;2004-2016&nbsp;&nbsp;京东JD.com&nbsp;版权所有<br>京东旗下网站：<a target="_blank" href="http://www.360top.com/">360TOP</a>&nbsp;&nbsp;<a href="#" target="_blank">拍拍网</a>&nbsp;&nbsp;<a href="#" target="_blank">网银在线</a></div>
		
		<div class="authentication">
			<a rel="nofollow" target="_blank" href="#">
				<img width="103" height="32" alt="经营性网站备案中心" src="/eshop/Public/Home/images/54b8871eNa9a7067e.png" class="err-product">
			</a>
			
			<a rel="nofollow" target="_blank" id="urlknet" tabindex="-1" href="#">
				<img border="true" width="103" height="32" onclick="CNNIC_change('urlknet')" oncontextmenu="return false;" name="CNNIC_seal" alt="可信网站" src="/eshop/Public/Home/images/54b8872dNe37a9860.png" class="err-product">
			</a>
			<a rel="nofollow" target="_blank" href="#">
				<img width="103" height="32" alt="网络警察" src="/eshop/Public/Home/images/56a89b8fNfbaade9a.jpg" class="err-product">
			</a>
			<a rel="nofollow" target="_blank" href="#">
				<img width="103" height="32" src="/eshop/Public/Home/images/54b8875fNad1e0c4c.png" class="err-product">
			</a>
			<a target="_blank" href="#"><img width="103" height="32" src="/eshop/Public/Home/images/5698dc03N23f2e3b8.jpg"></a>
			<a target="_blank" href="#"><img width="103" height="32" src="/eshop/Public/Home/images/5698dc16Nb2ab99df.jpg"></a>
		</div>
	  </div>
    </div>
  </div>
	...
	<script src="/eshop/Public/Home/js/jquery-1.11.3.min.js" ></script>
	<script src="/eshop/Public/Home/js/index.js" ></script>
</html>