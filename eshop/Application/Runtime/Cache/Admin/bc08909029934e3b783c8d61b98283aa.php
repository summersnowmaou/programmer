...
<body>
 <div class="wrap">
  ...
  <div class="operate">
   <form>
    <img src="/eshop/Public/Admin/images/icon_search.gif"/>
  ...
  <table class="list-style Interlaced">
   ...
   <tr>
    ...
    <td class="center">
     <a href="order_detail.html" class="inline-block" title="查看订单"><img src="/eshop/Public/Admin/images/icon_view.gif"/></a>
     <a class="inline-block" title="删除订单"><img src="/eshop/Public/Admin/images/icon_trash.gif"/></a>
    </td>
   </tr>
  </table>
  <!-- BatchOperation -->
